...
<p align="center">
  Лёгкий Windows-клиент для LibreRTC, сделанный для работы по протоколу "olcrtc", который помогает обходить БС, если БС в данный момент работает в регионе. Поддерживает Proxy и TUN режимы, системный tray, реальную телеметрию трафика и встроенный TUN-сервис на sing-box.
</p>
