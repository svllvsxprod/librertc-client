...
- Главное окно фиксированного размера `800x600`, без стандартной Windows рамки.
...
- Внешние Telegram/Tribute/NOWPayments ссылки проходят через allowlist в Rust backend.
